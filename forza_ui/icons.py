# -*- coding: utf-8 -*-
"""Icon cache, DPI scaling, and QApplication helper."""
...
class FCacheDict(object):
    _render = QSvgRenderer()

    def __init__(self, cls):
        super(FCacheDict, self).__init__()
        self.cls = cls
    ...
    def _render_svg(self, svg_path, replace_color=None):
        ...
        replace_color = replace_color or forza_theme.icon_color
...
FPixmap = FCacheDict(QtGui.QPixmap)
FIcon = FCacheDict(QtGui.QIcon)
