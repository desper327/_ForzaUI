...
@hover_shadow_mixin
@property_mixin
class FPopup(QtWidgets.QFrame):
    def __init__(self, parent=None):
        super(FPopup, self).__init__(parent)
    ...
    def mousePressEvent(self, event):
        ...
        return super(FPopup, self).mousePressEvent(event)

    def mouseReleaseEvent(self, event):
        self.mouse_pos = None
        return super(FPopup, self).mouseReleaseEvent(event)
    ...
    def mouseMoveEvent(self, event):
        ...
        return super(FPopup, self).mouseMoveEvent(event)

    def show(self):
        if self.property("animatable"):
            self.start_anim()
        self.move(QtGui.QCursor.pos())
        super(FPopup, self).show()
