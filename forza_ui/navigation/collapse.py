...
class FSectionItem(QtWidgets.QWidget):
    ...
    def _set_expand(self, value):
        ...
        self.expand_icon.setPixmap(FPixmap(icon_name).scaledToHeight(12))
...
class FCollapse(QtWidgets.QWidget):
    def __init__(self, parent=None):
        super(FCollapse, self).__init__(parent)
        self._section_list = []
