# -*- coding: utf-8 -*-
"""Theme engine and QSS template substitution."""

from __future__ import annotations

import string

from forza_ui import DEFAULT_STATIC_FOLDER
...
class FTheme(object):
    ...
    def __init__(self, theme="light", primary_color=None):
        ...
        self._init_color()
        self.set_primary_color(primary_color or FTheme.blue)
    ...
    def set_theme(self, theme):
        ...
        self._clear_delegate_paint_proxies()

    @staticmethod
    def _clear_delegate_paint_proxies() -> None:
        """Invalidate cached F* proxies used by delegate paint_appearance."""
        widget_classes = []
        try:
        ...
        for widget_cls in widget_classes:
            clear_fn = getattr(widget_cls, "clear_paint_proxies", None)
